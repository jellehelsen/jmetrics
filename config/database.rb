...
database_name = case Padrino.env
  when :development then 'jmetrics_development'
  when :production  then 'jmetrics_production'
  when :test        then 'jmetrics_test'
end
...
#     sessions:
#       default:
#         database: jmetrics_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: jmetrics_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: jmetrics_test
#         hosts:
#           - localhost:27017
#
#
